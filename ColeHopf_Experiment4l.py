...
folder_name = 'CH_exp4l'  # Folder to be created for saved output
...
with tf.name_scope("network"):
    ...
    output = tf.layers.dense(hidden2, n_outputs, name="outputs", activation=tf.exp, kernel_initializer=he_init,
                              kernel_regularizer=tf.contrib.layers.l2_regularizer(reg_lam), bias_regularizer=None)
