...
params = {}
params['data_name'] = 'Heat_Eqn_exp10c'  ## FILL IN HERE (from file name)
params['folder_name'] = 'exp10c' # UPDATE so goes in own folder
...
numICs = 15  # CHECK THIS (number of initial conditions)
