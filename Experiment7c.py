...
params['data_name'] = 'Heat_Eqn_exp7c'  ## FILL IN HERE (from file name)
params['folder_name'] = 'exp7c' # UPDATE so goes in own folder
...
numICs = 110  # CHECK THIS (number of initial conditions)
