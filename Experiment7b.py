...
params['data_name'] = 'Heat_Eqn_exp7b'  ## FILL IN HERE (from file name)
params['folder_name'] = 'exp7b' # UPDATE so goes in own folder
...
numICs = 11  # CHECK THIS (number of initial conditions)
