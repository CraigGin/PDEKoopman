...
params['data_name'] = 'Heat_Eqn_exp23'  ## FILL IN HERE (from file name)
params['folder_name'] = 'exp23d' # UPDATE so goes in own folder
...
params['len_time'] = 25  ## CHECK THIS (number of time steps)
