...
folder_name = 'ICH_exp3f'  # Folder to be created for saved output
...
my_conv_layer = partial(tf.layers.conv1d, activation=None, kernel_initializer=he_init,
...
with tf.name_scope("network"):
    ...
    hidden1 = my_conv_layer(X_reshaped, filters=conv1_filters, kernel_size=2, strides=1, padding="SAME",
                            name="hidden1")
    output = tf.reshape(hidden1, shape=[-1, n_outputs], name="outputs")
