...
folder_name = 'CH_exp2i'  # Folder to be created for saved output
...
with tf.name_scope("network"):
    ...
    a = tf.get_variable(name="a", shape=[], dtype=tf.float32, initializer=he_init, regularizer=tf.contrib.layers.l2_regularizer(reg_lam)) 
