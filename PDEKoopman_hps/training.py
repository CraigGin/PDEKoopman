...
def try_net(data_val, params):
    ...
    for f in range(params['data_train_len'] * params['num_passes_per_file']):
        ...
        if (params['data_train_len'] > 1) or (f == 0):
            ...
            data_train = np.load(('/home/craiggin/PDEKoopman/data/%s_train%d_x.npy' % (params['data_name'], file_num)))
...
def main_exp(params):
    ...
    data_val = np.load(('/home/craiggin/PDEKoopman/data/%s_val_x.npy' % (params['data_name'])))
