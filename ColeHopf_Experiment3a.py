...
n_epochs = 100  # Number of steps of optimization procedure
batch_size = 100  # Number of training examples in each batch of mini-batch optimization

folder_name = 'CH_exp3a'  # Folder to be created for saved output
...
with tf.name_scope("network"):
    ...
    b = tf.get_variable(name="b", dtype=tf.float32, initializer=0.0)
