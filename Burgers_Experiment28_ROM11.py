...
params['folder_name'] = 'Burgers_exp28_ROM11'  # UPDATE so goes in own folder
...
params['num_evals'] = 11  # how many eigenvalues / how many frequencies / what's the low dimension
l = params['num_evals']
