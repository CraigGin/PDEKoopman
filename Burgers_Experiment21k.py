...
params['folder_name'] = 'Burgers_exp21k'  # UPDATE so goes in own folder
params['restore'] = 0

params['seed_middle'] = 1
params['fix_middle'] = 1   # Can only fix middle layers if you also seed middle
...
params['max_time'] =  1 * 10 * 60  # this means each experiment will run up to 1 hr
