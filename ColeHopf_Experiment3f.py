...
folder_name = 'CH_exp3f'  # Folder to be created for saved output
...
with tf.name_scope("network"):
    ...
    initial = tf.random_normal((n_inputs,n_hidden1), mean=0, stddev=scale, dtype=tf.float32)
    W_full = tf.Variable(initial, name="W0", dtype=tf.float32)
    W = tf.matrix_band_part(W_full, 0, -1)
