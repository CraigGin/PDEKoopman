...
params['data_name'] = 'Heat_Eqn_exp21'  ## FILL IN HERE (from file name)
params['folder_name'] = 'exp21a' # UPDATE so goes in own folder

params['fixed_L'] = 1
params['dist_weights'] = 'dl'

params['num_evals'] = 20  ## CHECK THIS (how many eigenvalues / how many frequencies / what's the low dimension)
l = params['num_evals']
...
params['len_time'] = 5  ## CHECK THIS (number of time steps)

params['num_shifts'] = 3
params['delta_t'] = 0.01  ## FILL IN HERE: your time step

params['max_time'] =  60 * 60  # this means each experiment will run up to 1 hr
...
for count in range(200):
    ...
    params['learning_rate'] = 10**(-r.uniform(2.5, 3.5))
