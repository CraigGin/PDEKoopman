...
params = {}
params['data_name'] = 'KS_Eqn_exp5'  ## FILL IN HERE (from file name)
params['folder_name'] = 'KS_exp5f'  # UPDATE so goes in own folder
params['restore'] = 0 # Restore a previous model

n = 128  # number of inputs (spatial discretization)
params['delta_t'] = 0.125  # Time step
...
params['diag_L'] = 0  # Middle Layer (dynamics) forced to be diagonal 
