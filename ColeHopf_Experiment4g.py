...
# Widths of layers
n_inputs = 128
conv1_filters = 128 # Number of filters in first convolutional layer
n_outputs = 128
...
folder_name = 'CH_exp4g'  # Folder to be created for saved output
...
with tf.name_scope("network"):
    ...
    output = tf.reduce_sum(hidden2_scaled, axis=2, name="outputs")
