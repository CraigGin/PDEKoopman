...
params['data_name'] = 'Heat_Eqn_exp27'  ## FILL IN HERE (from file name)
params['folder_name'] = 'exp27' # UPDATE so goes in own folder
...
params['max_time'] =  6 * 60 * 60 # this means each experiment will run up to 1 hr
...
params['min_5min'] = 3 # essentially no checking
params['min_20min'] = 1.3
params['min_40min'] = 1.15
params['min_1hr'] = 1.1
params['min_2hr'] = 1
params['min_3hr'] = 0.975
params['min_4hr'] = 0.97
params['min_halfway'] = 0.975 # 1 hours
