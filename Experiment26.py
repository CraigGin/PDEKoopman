...
params['data_name'] = 'Heat_Eqn_exp26'  ## FILL IN HERE (from file name)
params['folder_name'] = 'exp26' # UPDATE so goes in own folder
...
params['len_time'] = 20  ## CHECK THIS (number of time steps)

params['num_shifts'] = 3
params['delta_t'] = 0.001  ## FILL IN HERE: your time step
...
numICs = 10000  # CHECK THIS (number of initial conditions)
...
params['min_3hr'] = 1.15
params['min_4hr'] = 1.1
params['min_halfway'] = 1.05 # 1 hours
