...
params['data_name'] = 'Heat_Eqn_exp6d'  ## FILL IN HERE (from file name)
params['folder_name'] = 'exp6d' # UPDATE so goes in own folder
...
n = 256  # number of inputs (spatial discretization)
...
numICs = 100  # CHECK THIS (number of initial conditions)
