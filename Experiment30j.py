...
params['folder_name'] = 'exp30j' # UPDATE so goes in own folder
...
# relu (128 - 128), relu(128 - 128), lin (128 - 128)
#
params['widths'] = [n, n, n, l, l, n, n, n]
params['linear_encoder_layers'] = [1,2] # 0 is relu, 1&2 are linear
params['linear_decoder_layers'] = [0,2] # 0 linear, 1 relu, 2 linear
