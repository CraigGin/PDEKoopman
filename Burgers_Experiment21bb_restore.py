...
def BestErrorFile(folder_name):
	...
	for file in glob.glob("*.pkl"):
		with open(file, 'rb') as f:
			...
			if not math.isnan(params['minRegTrain']):
				if params['minRegTrain'] < best_error:
					filename_best = file
					best_error = params['minRegTrain']
        os.chdir(current_dir)

	return filename_best

folder_name = './Burgers_exp21bb/'
...
params['min_5min'] = 2
params['min_20min'] = 1.1
params['min_40min'] = 1.05
params['min_1hr'] = 1
params['min_2hr'] = 1
params['min_3hr'] = 1
params['min_4hr'] = 1
params['min_halfway'] = 0.9
