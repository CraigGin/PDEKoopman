...
params = {}
params['data_name'] = 'Heat_Eqn_exp8'  ## FILL IN HERE (from file name)
params['folder_name'] = 'exp8' # UPDATE so goes in own folder
...
numICs = 30  # CHECK THIS (number of initial conditions)
