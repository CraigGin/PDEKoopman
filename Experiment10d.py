...
params = {}
params['data_name'] = 'Heat_Eqn_exp10d'  ## FILL IN HERE (from file name)
params['folder_name'] = 'exp10d' # UPDATE so goes in own folder
...
n = 129  # number of inputs (spatial discretization)
