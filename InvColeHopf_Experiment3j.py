...
folder_name = 'ICH_exp3j'  # Folder to be created for saved output
...
with tf.name_scope("network"):
    ...
    hidden1 = my_conv_layer(X_reshaped, filters=conv1_filters, kernel_size=3, strides=1, padding="SAME",
                            name="hidden1")
