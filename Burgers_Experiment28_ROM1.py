...
params['folder_name'] = 'Burgers_exp28_ROM1'  # UPDATE so goes in own folder
...
params['num_evals'] = 1  # how many eigenvalues / how many frequencies / what's the low dimension
l = params['num_evals']
