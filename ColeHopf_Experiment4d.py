...
folder_name = 'CH_exp4d'  # Folder to be created for saved output
...
with tf.name_scope("network"):
    ...
    log_output = tf.layers.dense(hidden1_flat, n_outputs, name="log_output", activation=None, kernel_initializer=he_init,
                              kernel_regularizer=tf.contrib.layers.l2_regularizer(reg_lam), bias_regularizer=None)
