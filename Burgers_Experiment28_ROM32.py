...
params['folder_name'] = 'Burgers_exp28_Rom32'  # UPDATE so goes in own folder
...
params['num_evals'] = 32  # how many eigenvalues / how many frequencies / what's the low dimension
l = params['num_evals']
