...
folder_name = 'CH_exp4j'  # Folder to be created for saved output
...
with tf.name_scope("network"):
    ...
    hidden3_scaled= a*hidden3
    log_output = tf.reduce_sum(hidden3_scaled, axis=2, name="log_output")
    output = tf.exp(log_output, name="outputs")
