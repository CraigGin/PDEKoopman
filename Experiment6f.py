...
params['data_name'] = 'Heat_Eqn_exp6f'  ## FILL IN HERE (from file name)
params['folder_name'] = 'exp6f' # UPDATE so goes in own folder

params['autoencoder_only'] = 1
params['dist_weights'] = 'dl'

params['num_evals'] = 5  ## CHECK THIS (how many eigenvalues / how many frequencies / what's the low dimension)
l = params['num_evals']
