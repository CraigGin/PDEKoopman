...
% Create data sets for Experiment 20
...
%   256 spatial points in [-pi,pi)
% Validation data:
%    same structure as training data but with less random lin combos
%
...
T = 1;  % End time
n_time = 101; % Number of time steps
n_IC = 25; % number of initial conditions
exp_num = 'exp20';
data_set = 'val_x';
% Specify training data, validation data, or testing data in file name
