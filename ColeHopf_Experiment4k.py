...
# Widths of layers
n_inputs = 128
conv1_filters = 1 # Number of filters in first convolutional layer
conv2_filters = 1 # Number of filters in first convolutional layer
conv3_filters = 1 # Number of filters in first convolutional layer
conv4_filters = 1 # Number of filters in first convolutional layer
conv5_filters = 1 # Number of filters in first convolutional layer
conv6_filters = 1 # Number of filters in first convolutional layer
conv7_filters = 1 # Number of filters in first convolutional layer
conv8_filters = 1 # Number of filters in first convolutional layer
conv9_filters = 1 # Number of filters in first convolutional layer
n_outputs = 128
...
folder_name = 'CH_exp4k'  # Folder to be created for saved output
...
with tf.name_scope("network"):
    ...
    hidden1 = my_conv_layer(log_X_reshaped, filters=conv1_filters, kernel_size=1, strides=1, padding="VALID",
                             name="hidden1")
    hidden2 = my_conv_layer(hidden1, filters=conv2_filters, kernel_size=1, strides=1, padding="SAME",
                             name="hidden2")
    hidden3 = my_conv_layer(hidden2, filters=conv3_filters, kernel_size=1, strides=1, padding="SAME",
                             name="hidden3")
    hidden4 = my_conv_layer(hidden3, filters=conv4_filters, kernel_size=1, strides=1, padding="SAME",
                             name="hidden4")
    hidden5 = my_conv_layer(hidden4, filters=conv5_filters, kernel_size=1, strides=1, padding="SAME",
                             name="hidden5")
    hidden6 = my_conv_layer(hidden5, filters=conv6_filters, kernel_size=1, strides=1, padding="SAME",
                             name="hidden6")
    hidden7 = my_conv_layer(hidden6, filters=conv7_filters, kernel_size=1, strides=1, padding="SAME",
                             name="hidden7")
    hidden8 = my_conv_layer(hidden7, filters=conv8_filters, kernel_size=1, strides=1, padding="SAME",
                             name="hidden8")
    hidden9 = my_conv_layer(hidden8, filters=conv9_filters, kernel_size=1, strides=1, padding="SAME",
                             name="hidden9")
    hidden9_flat = tf.reshape(hidden9, shape=[-1, n_outputs])
    output = tf.exp(hidden9_flat, name="outputs")
